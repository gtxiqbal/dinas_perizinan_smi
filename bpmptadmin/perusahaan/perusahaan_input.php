                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <textarea name="alamat_pemilik" cols="30" rows="5" class="form-control no-resize" required></textarea>
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="luas_perusahaan" type="text" required class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="sektor_usaha" placeholder="Silakan Ketikan Nama Kecamatan..." id="jenis_sektor1" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tlp_perusahaan" type="number" required class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tahun_berdiri" type="number" required class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>                    
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text"  id="date" class="form-control floating-label" name="tgl_berkas" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="no_izin" type="text" required class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tgl_register_izin" type="text" id="date2" class="form-control floating-label" required class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>                    
                                </div>
