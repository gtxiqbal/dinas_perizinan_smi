...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>EDIT NILAI INVESTASI TAHUNAN PERUSAHAAN</h2>
<!--                             <ul class="header-dropdown m-r--5">
                ...
                <div class="body">
                    <form action="?hal=<?php echo base64_encode ('investasi_perusahaan_update_proses'); ?>" method="POST"  id="form_validation" name="form_validation">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                            <input type="hidden" name="user_edit" value="<?php echo $cari3['user_nama']; ?>">
                                            ...
                                            <input type="hidden" name="id_investasi" value="<?php echo $datacari['id_investasi']; ?>">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="jumlah_investasi" type="number" required class="form-control" value="<?php echo $datacari['jumlah_investasi']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tahun" type="number" required class="form-control" value="<?php echo $datacari['tahun']; ?>">
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="sektor_usaha" readonly="yess" type="text" class="form-control" value="<?php echo $datacari['sektor_usaha']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="bidang_usaha" type="text" class="form-control" value="<?php echo $datacari['bidang_usaha']; ?>" required>
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tenaga_kerja_dalam" type="number" class="form-control" value="<?php echo $datacari['tenaga_kerja_dalam']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tenaga_kerja_luar" type="number" class="form-control" value="<?php echo $datacari['tenaga_kerja_luar']; ?>" required>
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
...
<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
          <thead>
              <tr>
                ...
                <?php if (($cari3['keterangan']=="Administrator")) { // Show if recordset not empty ?>
