        ...
        if(empty($_POST['nama_kecamatan']) || empty($_POST['luas_kecamatan'])){
            ...
            echo '<meta http-equiv="refresh" content="0; url=home.php?hal=a2VjYW1hdGFuX3ZpZXc=">';
                    ...
                    if(count($errors) > 0){
                        ...
                        $query = mysql_query("UPDATE tbl_kecamatan SET nama_kecamatan='$nama_kecamatan', luas_kecamatan='$luas_kecamatan', satuan_luas='$satuan_luas', jumlah_desa='$jumlah_desa', jumlah_kelurahan='$jumlah_kelurahan' ,latitude='$latitude',longitude='$longitude' WHERE id_kecamatan='$id_kecamatan'");
