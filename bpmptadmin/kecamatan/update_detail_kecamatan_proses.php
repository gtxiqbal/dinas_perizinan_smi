        ...
        if(empty($_POST['nama_kecamatan']) || empty($_POST['id_kecamatan'])){
            echo ("<SCRIPT LANGUAGE='JavaScript'>window.alert('MAAF, Data Kecamatan tidak terisi!')
                    ...
                    if(count($errors) > 0){
                        ...
                        $query = mysql_query("UPDATE detail_kecamatan SET id_kecamatan='$id_kecamatan',nama_kecamatan='$nama_kecamatan', jumlah_penduduk='$jumlah_penduduk', tahun='$tahun' WHERE id_detail_kecamatan='$id_detail_kecamatan'");
