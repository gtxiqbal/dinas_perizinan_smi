                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="jumlah_penduduk" type="number" required class="form-control" value="<?php echo $datacari['jumlah_penduduk']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
...
<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
          ...
          <?php
              ...
              <tr>
                  ...
                  <td><span class="style9"><?php echo $data['jumlah_penduduk']; ?></span></td>
