                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="luas_kecamatan" type="text" required class="form-control" value="<?php echo $data['luas_kecamatan']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="jumlah_desa" type="number" class="form-control" value="<?php echo $data['jumlah_desa']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="jumlah_kelurahan" type="number" required class="form-control" value="<?php echo $data['jumlah_kelurahan']; ?>">
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
