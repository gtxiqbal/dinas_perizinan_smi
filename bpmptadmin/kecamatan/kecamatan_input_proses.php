    ...
    $longitude     = $_POST['longitude'];
        ...
        if(empty($_POST['nama_kecamatan']) || empty($_POST['luas_kecamatan'])){
            ...
            echo '<meta http-equiv="refresh" content="0; url=home.php?hal=a2VjYW1hdGFuX2lucHV0">';
                    ...
                    $query = mysql_query("INSERT INTO tbl_kecamatan (nama_kecamatan,luas_kecamatan,satuan_luas,jumlah_desa,jumlah_kelurahan,latitude,longitude) VALUES ('$nama_kecamatan','$luas_wilayah','$satuan_luas','$jumlah_desa','$jumlah_kelurahan','$latitude','$longitude');");
