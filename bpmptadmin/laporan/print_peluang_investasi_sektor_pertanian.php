          ...
          <tbody>
            <?php
              ...
              <tr>
                  ...
                  <td align="right"><?php echo $data['kapasitas_produksi']; ?></td>
                  <td align="right"><?php echo $data['luas_lahan']; ?> <?php echo $data['satuan_luas']; ?></td>
                  <td><?php echo $data['sarana_prasarana']; ?></td>
                  <td align="right"><?php echo $data['tenaga_kerja_dalam']; ?></td>
                  <td align="right"><?php echo $data['tenaga_kerja_luar']; ?></td>
                  <td align="right"><?php echo $data['perkiraan_investasi']; ?></td>
