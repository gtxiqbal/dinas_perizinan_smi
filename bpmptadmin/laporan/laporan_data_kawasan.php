            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA KAWASAN KABUPATEN SUKABUMI
                                </h2>
                                <br/>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                     <form name="cari" method="GET"><button type="button" class="btn bg-cyan waves-effect"><a href="" onclick="MM_openBrWindow('laporan/print_laporan_data_kawasan.php','','scrollbars=yes')"><i class="material-icons">print</i></a></button>
...
<table class="table table-bordered table-striped table-hover dataTable js-exportable">
          <thead>
              <tr>
                ...
                <th><span class="style10">Nama Kawasan</span></th>
                <th><span class="style10">Luas Wilayah</span></th>
                <th><span class="style10">Lokasi Kawasan</span></th>
                <!-- <th>Satuan Luas</th> -->
                <!-- <th>Jumlah Desa</th>
          ...
          <?php
              ...
              <tr>
                  ...
                  <td><span class="style9"><?php echo $data['luas_kawasan']; ?> <?php echo $data['satuan_luas']; ?></span></td>
                  <td><span class="style9"><?php echo $data['nama_kecamatan']; ?></span></td>
                  <!-- <td><?php echo $data['jumlah_desa']; ?></td>
