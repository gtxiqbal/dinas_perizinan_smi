          ...
          <tbody>
            <?php
              ...
              <tr>
                  ...
                  <td align="right"><?php echo $data['sisa_akhir_tahun_lalu']; ?> <?php echo $data['satuan_sisa_akhir_tahun_lalu']; ?></td>
                  <td align="right"><?php echo $data['penanaman_normal']; ?> <?php echo $data['satuan_penanaman']; ?></td>
                  <td align="right"><?php echo $data['puso']; ?> <?php echo $data['satuan_puso']; ?></td>
                  <td align="right"><?php echo $data['luas_panen_kotor']; ?> <?php echo $data['satuan_luas_panen_kotor']; ?></td>
                  <td align="right"><?php echo $data['luas_panen_bersih']; ?> <?php echo $data['satuan_panen_bersih']; ?></td>
                  <td align="right"><?php echo $data['hasil_per_hektar']; ?> <?php echo $data['satuan_hasil_per_hektar']; ?></td>
                  <td align="right"><?php echo $data['kapasitas_produksi']; ?> <?php echo $data['satuan_kapasitas']; ?></td>
                  <td align="right"><?php echo $data['sisa_akhir_tahun_ini']; ?> <?php echo $data['satuan_sisa_akhir_tahun_ini']; ?></td>
