        ...
        if(empty($_POST['nama_kecamatan']) || empty($_POST['id_kecamatan'])){
            echo ("<SCRIPT LANGUAGE='JavaScript'>window.alert('MAAF, Data Penggunaan Lahan Sektor Pertanian tidak terisi!')
                    ...
                    $query = mysql_query("INSERT INTO tbl_penggunaan_lahan 
                        (nama_lahan,jenis_lahan,nama_kecamatan,id_kecamatan,tahun,ditanami_padi_satu,ditanami_padi_dua,ditanami_padi_lebih_tiga,ditanami_tanaman_lain,tidak_ditanami_apapun) VALUES 
                        ('$nama_lahan','$jenis_lahan','$nama_kecamatan','$id_kecamatan','$tahun','$ditanami_padi_satu','$ditanami_padi_dua','$ditanami_padi_lebih_tiga','$ditanami_tanaman_lain','$tidak_ditanami_apapun');");
