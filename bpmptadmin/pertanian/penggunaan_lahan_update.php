                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="nama_lahan" id="nama_lahan1" placeholder="Ketikan Nama Lahan..." type="text" required class="form-control" value="<?php echo $data['nama_lahan']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="jenis_lahan" id="jenis_lahan1" type="text" required class="form-control" value="<?php echo $data['jenis_lahan']; ?>">
                                            </div>
                                        </div>
                                    </div> 
