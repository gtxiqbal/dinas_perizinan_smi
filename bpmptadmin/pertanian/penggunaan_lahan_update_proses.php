        ...
        if(empty($_POST['nama_kecamatan']) || empty($_POST['id_kecamatan'])){
            echo ("<SCRIPT LANGUAGE='JavaScript'>window.alert('MAAF, Data Penggunaan Lahan Sektor Pertanian tidak terisi!')
                    ...
                    if(count($errors) > 0){
                        ...
                        $query = mysql_query("UPDATE tbl_penggunaan_lahan SET nama_kecamatan='$nama_kecamatan',id_kecamatan='$id_kecamatan',nama_lahan='$nama_lahan',jenis_lahan='$jenis_lahan',tahun='$tahun',ditanami_padi_satu='$ditanami_padi_satu',ditanami_padi_dua='$ditanami_padi_dua',ditanami_padi_lebih_tiga='$ditanami_padi_lebih_tiga',ditanami_tanaman_lain='$ditanami_tanaman_lain',tidak_ditanami_apapun='$tidak_ditanami_apapun' WHERE id_penggunaan_lahan  ='$id_penggunaan_lahan'");
