...
<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
          ...
          <?php
              ...
              <tr>
                  ...
                  <td><span class="style9"><?php echo $data['kapasitas_produksi']; ?> <?php echo $data['satuan_kapasitas']; ?></span></td>
                  <td><span class="style9"><?php echo $data['hasil_per_hektar']; ?> <?php echo $data['satuan_hasil_per_hektar']; ?></span></td>
                  <td><span class="style9"><?php echo $data['penanaman_normal']; ?> <?php echo $data['satuan_penanaman']; ?></span></td>
                  <td><span class="style9"><?php echo $data['puso']; ?> <?php echo $data['satuan_puso']; ?></span></td>
                  <td><span class="style9"><?php echo $data['tambah_tanam']; ?> <?php echo $data['satuan_tambah_tanam']; ?></span></td>
                  <td><span class="style9"><?php echo $data['luas_lahan']; ?> <?php echo $data['satuan_luas']; ?></span></td>
                  <td><span class="style9"><?php echo $data['luas_panen_kotor']; ?> <?php echo $data['satuan_luas_panen_kotor']; ?></span></td>
                  <td><span class="style9"><?php echo $data['luas_panen_bersih']; ?> <?php echo $data['satuan_panen_bersih']; ?></span></td>
                  ...
                  <td><span class="style9"><?php echo $data['sisa_akhir_tahun_lalu']; ?> <?php echo $data['satuan_sisa_akhir_tahun_lalu']; ?></span></td>
                  <td><span class="style9"><?php echo $data['sisa_akhir_tahun_ini']; ?> <?php echo $data['satuan_sisa_akhir_tahun_ini']; ?></span></td>
