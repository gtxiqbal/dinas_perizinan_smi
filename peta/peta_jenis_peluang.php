          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header ">
                Peta Potensi dan Peluang Investasi <?php echo $_GET['jenis_peluang']; ?> Kabupaten Sukabumi
              </div>
              <div class="card-body ">
...
$id = $_GET['kawasan'];
$idd = $_GET['kecamatan'];
$iddd = $_GET['jenis_peluang'];

  $carimap = mysql_query("SELECT * FROM tbl_kawasan WHERE nama_kawasan LIKE'%".$id."%' AND nama_kecamatan LIKE'%".$idd."%' AND jenis_peluang LIKE'%".$iddd."%' AND latitude IS NOT NULL");
