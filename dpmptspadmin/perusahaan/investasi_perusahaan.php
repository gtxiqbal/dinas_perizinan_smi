                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="jumlah_investasi" type="number" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="sektor_usaha" readonly="yess" type="text" class="form-control" value="<?php echo $data['sektor_usaha']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="bidang_usaha" type="text" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tenaga_kerja_luar" type="number" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
