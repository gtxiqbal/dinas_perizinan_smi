                            ...
                            <div class="demo-masked-input">
                                ...
                                <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <textarea name="kemitraan" cols="30" rows="5" class="form-control no-resize" value="<?php echo $data['kemitraan']; ?>"><?php echo $data['kemitraan']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="nama_pemilik" type="text" class="form-control" value="<?php echo $data['nama_pemilik']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <textarea name="alamat_pemilik" cols="30" rows="5" class="form-control no-resize" value="<?php echo $data['alamat_pemilik']; ?>"><?php echo $data['alamat_pemilik']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>                   
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="luas_perusahaan" type="text" class="form-control" value="<?php echo $data['luas_perusahaan']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="sektor_usaha" value="<?php echo $data['sektor_usaha']; ?>" placeholder="Silakan Ketikan Sektor Usaha..." id="jenis_sektor1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tlp_perusahaan" type="number" class="form-control" value="<?php echo $data['tlp_perusahaan']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tahun_berdiri" type="number" class="form-control" value="<?php echo $data['tahun_berdiri']; ?>">
                                            </div>
                                        </div>
                                    </div>                    
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text"  id="date" class="form-control floating-label" value="<?php echo $data['tgl_berkas']; ?>" name="tgl_berkas" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="no_izin" type="text" class="form-control" value="<?php echo $data['no_izin']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tgl_register_izin" type="text" id="date2" class="form-control floating-label" class="form-control" value="<?php echo $data['tgl_register_izin']; ?>">
                                            </div>
                                        </div>
                                    </div>                    
                                </div>
