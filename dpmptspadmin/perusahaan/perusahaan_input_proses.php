    ...
    $kemitraan     = $_POST['kemitraan'];
        ...
        if(empty($_POST['nama_perusahaan']) || empty($_POST['luas_perusahaan'])){
            ...
            echo '<meta http-equiv="refresh" content="0; url=home.php?hal=cGVydXNhaGFhbl9pbnB1dA==">';
                    ...
                    $query = mysql_query("INSERT INTO tbl_perusahaan (nama_perusahaan,alamat_perusahaan,nama_pemilik,alamat_pemilik,tlp_perusahaan,id_kecamatan,nama_kecamatan,sektor_usaha,luas_perusahaan,satuan_luas,tahun_berdiri,kemitraan,tgl_berkas,no_izin,tgl_register_izin,latitude,longitude,user_input) VALUES ('$nama_perusahaan','$alamat_perusahaan','$nama_pemilik','$alamat_pemilik','$tlp_perusahaan','$id_kecamatan','$nama_kecamatan','$sektor_usaha','$luas_perusahaan','$satuan_luas','$tahun_berdiri','$kemitraan','$tgl_berkas','$no_izin','$tgl_register_izin','$latitude','$longitude','$user_input');");
