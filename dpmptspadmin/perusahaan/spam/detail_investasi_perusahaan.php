<?php  
  ...
  $cari = mysql_query("SELECT * FROM investasi_tahunan_perusahaan WHERE id_investasi='".$iddd."'");
  $datainves = mysql_fetch_array($cari);
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>INPUT DETAIL NILAI INVESTASI PERUSAHAAN</h2>
<!--                             <ul class="header-dropdown m-r--5">
                ...
                <div class="body">
                    <form action="?hal=<?php echo base64_encode ('detail_investasi_perusahaan_input'); ?>" method="POST"  id="form_validation" name="form_validation">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="sektor_usaha" value="<?php echo $_GET['sektor_usaha']; ?>">
                                                <input name="nama_perusahaan" type="text" class="form-control" readonly="yess" value="<?php echo $data['nama_perusahaan']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="tahun" type="number" class="form-control" readonly="yess" value="<?php echo $datainves['tahun']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
