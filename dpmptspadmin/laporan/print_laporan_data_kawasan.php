...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><strong>DATA KAWASAN KABUPATEN SUKABUMI</strong></td>
  </tr>
  <tr>
    <td><table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-hover dataTable js-exportable">
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo $no; ?></td>
          <td><?php echo $data['nama_kawasan']; ?></td>
          <td align="right"><?php echo number_format($data['luas_kawasan'] ,0,",","."); ?> <?php echo $data['satuan_luas']; ?></td>
          <td><?php echo $data['nama_kecamatan']; ?></td>
          <!-- <td><?php echo $data['satuan_luas']; ?></td> -->
          <!-- <td align="right"><?php echo $data['jumlah_desa']; ?></td>
          <td align="right"><?php echo $data['jumlah_kelurahan']; ?></td> -->
