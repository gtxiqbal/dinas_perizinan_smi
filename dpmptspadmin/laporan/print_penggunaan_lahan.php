          ...
          <tbody>
            <?php
              ...
              <tr>
                  ...
                  <td align="right"><?php echo number_format($data['ditanami_padi_satu'] ,0,",","."); ?></td>
                  <td align="right"><?php echo number_format($data['ditanami_padi_dua'] ,0,",","."); ?></td>
                  <td align="right"><?php echo number_format($data['ditanami_padi_lebih_tiga'] ,0,",","."); ?></td>
                  <td align="right"><?php echo number_format($data['ditanami_tanaman_lain'] ,0,",","."); ?></td>
                  <td align="right"><?php echo number_format($data['tidak_ditanami_apapun'] ,0,",","."); ?></td>
              </tr>
<?php
                    $no++;
                }
