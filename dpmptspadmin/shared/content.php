            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">JUMLAH INVESTASI KABUPATEN SUKABUMI</div>
                    ...
                    ?>
                            Tahun <?php echo $data22['tahun']; ?>: Rp. <?php echo number_format($data22['investasi'] ,0,",","."); ?>&nbsp;&nbsp;&nbsp;
                            <?php
                    $no++;
                }
            ?>
                ...
                <!-- Latest Social Trends -->
                 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA INVESTASI PER SEKTOR USAHA TAHUN <?php echo date('Y');?></h2>
                                <br/>
<!--                             <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            <!-- Latest Social Trends -->
                 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA KAWASAN POTENSI DAN PELUANG INVESTASI TAHUN <?php echo date('Y');?></h2>
                                <br/>
<!--                             <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
