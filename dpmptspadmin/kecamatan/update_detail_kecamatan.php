<?php  
  ...
  $cari = mysql_query("SELECT * FROM detail_kecamatan WHERE id_detail_kecamatan='".$idd."'");
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>EDIT DATA DETAIL KECAMATAN</h2>
<!--                             <ul class="header-dropdown m-r--5">
                ...
                <div class="body">
                    <form action="?hal=<?php echo base64_encode ('update_detail_kecamatan_proses'); ?>" method="POST"  id="form_validation" name="form_validation">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" name="user" value="<?php echo $cari3['user_nama']; ?>">
                                                <input type="hidden" name="id_detail_kecamatan" value="<?php echo $datacari['id_detail_kecamatan']; ?>">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="jumlah_penduduk" type="number" class="form-control" value="<?php echo $datacari['jumlah_penduduk']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
