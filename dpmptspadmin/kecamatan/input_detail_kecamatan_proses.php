    ...
    $user     = $_POST['user'];
        ...
        if(empty($_POST['nama_kecamatan']) || empty($_POST['id_kecamatan'])){
            echo ("<SCRIPT LANGUAGE='JavaScript'>window.alert('MAAF, Data Kecamatan tidak terisi!')
                    ...
                    $query = mysql_query("INSERT INTO detail_kecamatan (id_kecamatan,nama_kecamatan,jumlah_penduduk,tahun,user_input) VALUES ('$id_kecamatan','$nama_kecamatan','$jumlah_penduduk','$tahun','$user');");
