    ...
    $jenis_peluang     = $_POST['jenis_peluang'];
        ...
        if(empty($_POST['nama_kawasan']) || empty($_POST['luas_kawasan'])){
            ...
            echo '<meta http-equiv="refresh" content="0; url=home.php?hal=a2F3YXNhbl9pbnB1dA==">';
                    ...
                    $query = mysql_query("INSERT INTO tbl_kawasan (nama_kawasan,jenis_peluang,luas_kawasan,satuan_luas,id_kecamatan,nama_kecamatan,latitude,longitude,user_input) VALUES ('$nama_kawasan','$jenis_peluang','$luas_kawasan','$satuan_luas','$id_kecamatan','$nama_kecamatan','$latitude','$longitude','$user');");
