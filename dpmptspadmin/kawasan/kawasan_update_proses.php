<?php
    ...
    if(isset($_POST['simpan'])) {
        ...
        $user   = $_POST['user'];
        $jenis_peluang   = $_POST['jenis_peluang'];
        ...
        if(empty($_POST['nama_kawasan']) || empty($_POST['luas_kawasan'])){
            ...
            echo '<meta http-equiv="refresh" content="0; url=home.php?hal=a2F3YXNhbl92aWV3">';
                    ...
                    if(count($errors) > 0){
                        ...
                        $query = mysql_query("UPDATE tbl_kawasan SET nama_kawasan='$nama_kawasan', jenis_peluang='$jenis_peluang',luas_kawasan='$luas_kawasan', satuan_luas='$satuan_luas',id_kecamatan='$id_kecamatan',nama_kecamatan='$nama_kecamatan',latitude='$latitude',longitude='$longitude', user_edit='$user' WHERE id_kawasan='$id_kawasan'");
